...
public:
    ...
    // Create a new OS window and a View inside it
    void createView(const ViewInfo& info, int w=800, int h=600)
    {
        osg::ref_ptr<osg::GraphicsContext::Traits> traits = new osg::GraphicsContext::Traits;
        // cascade position so new screens don’t stack perfectly
        ...
        traits->sharedContext = _sharedGC; // share with main GC (textures, VBOs, etc.)
