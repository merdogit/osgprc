...
int main()
{
    ...
    const std::string baseDir  = "/home/murate/Documents/SwTrn/OsgPrc/osgtrn060/";
    ...
    manip->setVerticalAxisFixed(false); // allow arbitrary up
    manip->setHomePosition(
        osg::Vec3d(0.0, -50.0, 0.0), // eye
        osg::Vec3d(0.0, 0.0, 0.0),   // center
        osg::Vec3d(0.0, 0.0, -1.0)); // up (downward Z)
